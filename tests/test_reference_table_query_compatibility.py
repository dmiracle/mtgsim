        ...
        **Validates: Requirements 3.2, 4.1**
        ...
        try:
            ...
            results, total = cards_data.search_cards(
                q=q, set_code=set_code, rarity=rarity, page=page, limit=limit, scope="reference"
            )
    ...
    def test_reference_set_search_compatibility(self, q, set_type, page, limit):
        ...
        **Validates: Requirements 3.2, 4.1**
        ...
        try:
            ...
            results, total = sets_data.list_sets(q=q, set_type=set_type, page=page, limit=limit, scope="reference")
    ...
    def test_reference_deck_search_compatibility(self, q, page, limit):
        ...
        **Validates: Requirements 3.2, 4.1**
        ...
        try:
            ...
            results, total = decks_data.list_decks(q=q, page=page, limit=limit, scope="reference")
    ...
    def test_reference_query_sorting_compatibility(self, sort, order):
        ...
        **Validates: Requirements 3.2, 4.1**
        ...
        try:
            ...
            results, total = cards_data.search_cards(sort=sort, order=order, limit=10, scope="reference")
            ...
            if len(results) > 1:
                ...
                if order == "asc":
                    ...
                    assert sort_values == sorted(sort_values, reverse=True), (
                        f"Results should be sorted descending by {sort}"
                    )
